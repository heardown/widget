 ...
 * Desc:
 */
public class ChildRecyclerView extends BaseNestedRecyclerView {
     ...
     * 1. 将自己上报ViewPager，通过tag关联到currentItem的View中
     * 2. 将ViewPager报告给ParentRecyclerView
     * 需要跟ParentRecyclerView连起来看，否则可能会懵
     */
